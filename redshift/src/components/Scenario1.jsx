...
const Scenario1 = () => {
  ...
  const getCallRecords = (suspectInfo) => {
    const token = localStorage.getItem(JWT);
    axios
      .get(`http://localhost:8080/queryPerson/callRecords`, {
        params: suspectInfo,
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
  ...
  const getOutboundCallRecords = (suspectInfo) => {
    const token = localStorage.getItem(JWT);
    axios
      .get(`http://localhost:8080/queryPerson/callRecordsOutbound`, {
        params: suspectInfo,
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
  ...
  const getAnprData = (suspectInfo) => {
    ...
    axios
      .get(`http://localhost:8080/queryPerson/anpr`, {
        params: suspectInfo,
        headers: { Authorization: `Bearer ${token}` },
      })
  ...
  const getAtmData = (suspectInfo) => {
    ...
    axios
      .get(`http://localhost:8080/queryPerson/atmData`, {
        params: suspectInfo,
        headers: { Authorization: `Bearer ${token}` },
      })
  ...
  const getEposData = (suspectInfo) => {
    ...
    axios
      .get(`http://localhost:8080/queryPerson/eposData`, {
        params: suspectInfo,
        headers: { Authorization: `Bearer ${token}` },
      })
  ...
  const getEposMapData = (suspectInfo) => {
    ...
    axios
      .get(`http://localhost:8080/mapData/eposMap`, {
        params: suspectInfo,
        headers: { Authorization: `Bearer ${token}` },
      })
  ...
  const getAtmMapData = (suspectInfo) => {
    ...
    axios
      .get(`http://localhost:8080/mapData/atmMap`, {
        params: suspectInfo,
        headers: { Authorization: `Bearer ${token}` },
      })
  ...
  const getAnprMapData = (suspectInfo) => {
    ...
    axios
      .get(`http://localhost:8080/mapData/anprMap`, {
        params: suspectInfo,
        headers: { Authorization: `Bearer ${token}` },
      })
  ...
  const getWork = (suspectInfo) => {
    const token = localStorage.getItem(JWT);
    axios
      .get(`http://localhost:8080/queryPerson/associates/`, {
        params: suspectInfo,
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
  ...
  const getHome = (suspectInfo) => {
    const token = localStorage.getItem(JWT);
    axios
      .get(`http://localhost:8080/queryPerson/associatesHome/`, {
        params: suspectInfo,
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
          ...
          <Row>
            ...
            <Col>
              <h3 class="font-weight-light">
                Transactions and logged vehicle locations:
              </h3>
              <MapContainer>
                <Map
                  eposMapData={eposMapData}
                  anprMapData={anprMapData}
                  atmMapData={atmMapData}
                />
              </MapContainer>
            </Col>
          </Row>
